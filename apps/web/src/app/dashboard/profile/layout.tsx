...
// Defense-in-depth: middleware already blocks non-super_users (PROFILE_PATH is
// part of the Super User console gate), but the layout re-checks so direct
// Server Action / route hits can't bypass the guard. Mirrors referrals/layout.tsx.
